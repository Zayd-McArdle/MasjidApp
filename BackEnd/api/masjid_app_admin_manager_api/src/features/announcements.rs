...
use masjid_app_api_library::features::announcements::{AnnouncementDTO, AnnouncementRepository, GetAnnouncementsError};
...
#[async_trait]
pub trait AnnouncementAdminRepository: AnnouncementRepository {
...
pub async fn new_announcement_admin_repository(db_type: DbType) -> Arc<dyn AnnouncementAdminRepository> {
    match db_type {
...
mod tests {
    ...
    use masjid_app_api_library::features::announcements::MockAnnouncementRepository;
