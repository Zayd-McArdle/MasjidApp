...
use masjid_app_admin_manager_api::features::donation::repositories::donation_history_admin_repository::{DonationHistoryAdminRepository, new_donation_history_admin_repository};
...
use masjid_app_api_library::shared::data_access::repository_management::connection_strings::DONATION_MYSQL_CONNECTION;
...
async fn test_donation() {
    ...
    let container = setup_container(DatabaseCredentials {
        ...
        environment_variable: DONATION_MYSQL_CONNECTION.to_owned(),
    })
    .await;
