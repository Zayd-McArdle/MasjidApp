...
const AUTHENTICATION_MYSQL_CONNECTION: &'static str = "AUTHENTICATION_CONNECTION";
const AUTHENTICATION_REDIS_CONNECTION: &'static str = "AUTHENTICATION_CONNECTION";
const PRAYER_TIMES_MYSQL_CONNECTION: &'static str = "PRAYER_TIMES_CONNECTION";
const PRAYER_TIMES_REDIS_CONNECTION: &'static str = "PRAYER_TIMES_CONNECTION";
const ASK_IMAM_MYSQL_CONNECTION: &'static str = "ASK_IMAM_CONNECTION";
const ASK_IMAM_REDIS_CONNECTION: &'static str = "ASK_IMAM_CONNECTION";
const EVENTS_MYSQL_CONNECTION: &'static str = "EVENTS_CONNECTION";
const EVENTS_REDIS_CONNECTION: &'static str = "EVENTS_CONNECTION";
