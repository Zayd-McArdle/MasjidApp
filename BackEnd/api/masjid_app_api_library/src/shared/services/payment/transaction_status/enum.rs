use crate::shared::services::payment::transaction_status::constants::APPROVED;
use crate::shared::services::payment::transaction_status::refund_status::RefundStatus;
use crate::shared::services::payment::transaction_status::transaction_declined_reason::TransactionDeclinedReason;
...
impl Display for TransactionStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let status_string = match self {
            ...
            TransactionStatus::RefundStatus(refund_status) => refund_status.to_string(),
        };
...
mod tests {
    use super::*;
    use crate::shared::services::payment::transaction_status::constants::{
