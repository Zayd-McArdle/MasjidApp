...
impl From<EventDTO> for Event {
    fn from(dto: EventDTO) -> Self {
        ...
        Self {
            ...
            recurrence: Option::from(dto.event_details.event_recurrence.unwrap().to_string()),
    ...
    fn from(event: Event) -> Self {
        ...
        Self {
            ...
            event_details: EventDetails {
                ...
                event_recurrence: EventRecurrence::from_str(
                    &event.recurrence.unwrap_or("".to_owned()),
                )
                .ok(),
